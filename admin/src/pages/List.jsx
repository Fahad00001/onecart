  ...
  return (
    <div className="w-[100vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-white">
      ...
      <div className="w-[100%] h-[100%] flex items-center justify-start">
        <Sidebar />
        <div className="w-[82%] h-[100%] lg:ml-[320px] md:ml-[230px] mt-[70px] flex flex-col gap-[30px] overfolw-x-hidden py-[50px] ml-[100px]">
            ...
            list.map((item, index) => (
              ...
              >
                <img
                  ...
                  alt=""
                />
                <div className="w-[90%] h-[80%] flex flex-col items-start justify-between gap-[20]">
                ...
                <div className="w-[10%] h-[100%] bg-transparent flex items-center justify-center">
                  <span
                    ...
                    className="w-[35px] h-[30%] flex items-center justify-center rounded-md md:hover:text-black md:hover:bg-red-300 cursor-pointer hover:text-red-300"
                  >
                    X
                  </span>
                </div>
