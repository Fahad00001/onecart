          ...
          <div key={index} className="w-[100%] h-[10%] border-t border-b">
            <div className="w-[100%] h-[80%] flex items-start gap-6 bg-[#51808048] py-[10px] px-[20px] rounded-2xl relative">
              ...
              <div className="flex items-start justify-center flex-col gap-[5px]">
                <p className="md:text-[25px] text-[20px] text-[#fefeff]">
                  {item.name}
                </p>
                <div className="flex items-center gap-[8px] md:gap-[20px]">
                  <p className="md:text-[18px] text-[12px] text-[#aaf4fe]">
                    {currency}
                    {}
                    {item.price}
                  </p>
                ...
                <div className="flex items-center">
                  <p className="md:text-[16px] text-[12px] text-[#aaf4fe]">
                ...
                <div className="absolute md:left-[55%] md:top-[40%] right-[2%] top-[2%]">
                  <div className="flex items-center gap-[5px] ">
                    ...
                    <p className="md:text-[17px] text-[10px] text-[#f3f9f9] ">
                      {item.status}
                    </p>
                  </div>
                </div>
                ...
                <div className="absolute md:right-[5%] right-[1%] md:top-[40%] top-[70%]">
                  <button
                    className="md:px-[15px] px-[5px] py-[3px] md:py-[17px] rounded-md bg-[#101919] text-[#f3f9f9] text-[12px] md:text-[16px] cursor-pointer active:bg-slate-500"
